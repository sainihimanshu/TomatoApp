...
public class Phone {
    ...
    public boolean arePlayServicesInstalled() {
        return prefs.getBoolean(Constants.Play_Services, false);
    }

    public void playServicesAreInstalled() {
        editor.putBoolean(Constants.Play_Services, true);
        editor.apply();
    }
}
